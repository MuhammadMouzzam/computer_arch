...
module data_mem
#(
    parameter int unsigned DEPTH = 64, // CHANGE: enough memory depth for insertion-sort FPGA implementation
...
(
    ...
    // CHANGE: outputs added to send array values to FPGA seven-segment display
    ...
    // CHANGE: expose first four data memory words for display
    assign array0 = memory[0];
    assign array1 = memory[1];
    assign array2 = memory[2];
    assign array3 = memory[3];
    ...
    initial begin
        ...
        // CHANGE: insertion-sort initial array loaded directly into data memory
        memory[0] = 32'd2; // arr[0] = 2
        memory[1] = 32'd4; // arr[1] = 4
        memory[2] = 32'd1; // arr[2] = 1
        memory[3] = 32'd3; // arr[3] = 3
